...
session.like_by_tags(["#fashiondaily", "#ootdfash", "#outfitinspo", "#whatiwore", "#currentlywearing", "#fashiongram",
                      ...
                      '#fashioninspiration', '#ootdsubmit', '#stylediary', '#detailsoftheday', 'artizia', 'myaritzia',
